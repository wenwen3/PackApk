...
import com.vone.weibaoshuiguo.util.FileUtils;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private void uploadExceptionToServer(Throwable ex) {
        final File file = new File(Environment.getExternalStorageDirectory() + "/weibao/","崩溃日志.txt");
        FileUtils.getInstance().createFile(file);
        FileUtils.getInstance().writeTxtToFile(file,ex.toString()+ex.getCause().toString()+"\n--------------------------------------");
    }
}
